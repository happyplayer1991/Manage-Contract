...
Job.create!(title: "Ruby on Rails programmer", job_type_id: 1, job_area_id: 1, salary_min: 450, salary_max: 500, hires: 1, description: "Some description", email: "seed@example.com", address: "Some Address", experience: 1, education_id: 2, user_id: 2)
Job.create!(title: "Rails Developer", job_type_id: 1, job_area_id: 1, salary_min: 500, salary_max: 1000, hires: 1, description: "Some description", email: "seed@example.com", address: "Some Address", experience: 2, education_id: 3, user_id: 2)
Job.create!(title: "Talent Rails proger", job_type_id: 1, job_area_id: 1, salary_min: 4500, salary_max: 5000, hires: 2, description: "Some description", email: "seed@example.com", address: "Some Address", experience: 4, education_id: 4, user_id: 2)
Job.create!(title: "Senior Ruby on Rails", job_type_id: 1, job_area_id: 1, salary_min: 14500, salary_max: 15000, hires: 1, description: "Some description", email: "seed@example.com", address: "Some Address", experience: 3, education_id: 5, user_id: 2)
